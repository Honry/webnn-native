async function load() {
  ...
  const MODEL_PATH = document.getElementById('model').value + '.tflite';
  ...
  const modelRunnerResult =
    module.TFLiteWebModelRunner.CreateFromBufferAndOptions(
      ...
      webNNDevicePreference: parseInt(document.getElementById('webnnDevice').value) // 0 - default, 1 - gpu, 2 - cpu
    });
